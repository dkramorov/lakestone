...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/seo_link')) {
				$catalog[] = array(
					'name'	   => 'SEO страницы',
					'href'     => $this->url->link('catalog/seo_link', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/external_review')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_external_review'),
					'href'     => $this->url->link('catalog/external_review', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'catalog/whatsapp_screen')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_whatsapp_screen'),
					'href'     => $this->url->link('catalog/whatsapp_screen', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/blog')) {
				$catalog[] = array(
					...
					'href'     => $this->url->link('catalog/blog', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			*/
			...
			if ($this->user->hasPermission('access', 'tool/yamarket_parser')) {
				$tool[] = array(
					'name'	   => $this->language->get('text_yamarket_parser'),
