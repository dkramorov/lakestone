...
$_['entry_yml_name']         = '<a target="_blank" href="https://yandex.ru/support/partnermarket/elements/name.html#vendor-name-model">YML: name</a>';
$_['entry_yml_model']        = '<a target="_blank" href="https://yandex.ru/support/partnermarket/elements/vendor-name-model.html">YML: model</a>';
$_['entry_short']            = 'Краткое описание товара';
...
$_['entry_isbn']             = 'ISBN';
$_['entry_mpn']              = 'MPN';
$_['entry_externalId']       = 'Идентификатор системы "Мой склад"';
...
$_['entry_position']         = 'Позиция изображения';
$_['entry_category']         = 'Показывать в категориях';
$_['entry_filter']           = 'Фильтры';
$_['entry_download']         = 'Загрузки';
$_['entry_related']          = 'Этот товар другого цвета';
$_['entry_tag']          	 	 = 'Теги товара';
$_['entry_reward']           = 'Бонусные баллы';
$_['entry_layout']           = 'Макет';
$_['entry_recurring']        = 'Профиль периодичности';
$_['entry_externalLink']     = 'Внешний идентификаторы в системе "Мой Склад"<br><i>!!! лучше не трогать !!!</i>';
$_['entry_externalId']       = 'идентификатор';
$_['entry_externalCode']     = 'код товара';
$_['entry_externalCodeMod']  = 'код модификации';
...
$_['help_yml_name']          = 'Параметр <q>name</q> файла стандарта YML, описание по ссылке в новом окне';
$_['help_yml_model']         = 'Параметр <q>model</q> файла стандарта YML, описание по ссылке в новом окне';
