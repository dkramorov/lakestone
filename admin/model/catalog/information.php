...
class ModelCatalogInformation extends Model {
	...
	public function getSidebar() {
		$query = $this->db->query("SELECT isd.*, i.title FROM " . DB_PREFIX . "information_sidebar AS isd
		LEFT JOIN " . DB_PREFIX . "information_description AS i ON (i.information_id = isd.information_id)
		ORDER BY isd.position, LCASE(isd.name) ASC");
	...
	public function editSidebar($data) {
		if (isset($data['sidebar'])) {
			$this->db->query("DELETE FROM " . DB_PREFIX . "information_sidebar");
			foreach ($data['sidebar'] as $bar) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "information_sidebar SET
					`information_id` = '" . (int)$bar['information_id'] . "',
