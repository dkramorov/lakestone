              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <a id="thumb-image<?php echo $language['language_id']; ?>" href="" data-toggle="image" class="img-thumbnail"><img src="<?php echo isset($blog_description[$language['language_id']]['image_url']) ? $blog_description[$language['language_id']]['image_url'] : $placeholder; ?>" data-placeholder="<?php echo $placeholder; ?>" /></a>
                      <input type="hidden" name="blog_description[<?php echo $language['language_id']; ?>][image]" value="<?php echo isset($blog_description[$language['language_id']]['image']) ? $blog_description[$language['language_id']]['image'] : ''; ?>" id="input-image<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea name="blog_description[<?php echo $language['language_id']; ?>][announce]" placeholder="<?php echo $entry_announce; ?>" id="input-announce<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($blog_description[$language['language_id']]) ? $blog_description[$language['language_id']]['announce'] : ''; ?></textarea>
