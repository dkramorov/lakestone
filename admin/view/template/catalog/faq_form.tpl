                  ...
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?>
                      <div class="">
                        ...
                        <dl>
                          <dt>{{phone}}</dt>
                          <dd>контактный телефон</dd>
                          <dt>{{email}}</dt>
                          <dd>контактный eMail</dd>
                        </dl>
                      </div>
                    </label>
                    <div class="col-sm-10">
                      <textarea name="faq_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($faq_description[$language['language_id']]) ? $faq_description[$language['language_id']]['description'] : ''; ?></textarea>
...
<?/*
                  <!-- <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="faq_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($faq_description[$language['language_id']]) ? $faq_description[$language['language_id']]['meta_title'] : ''; ?>" placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="faq_description[<?php echo $language['language_id']; ?>][meta_description]" rows="5" placeholder="<?php echo $entry_meta_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($faq_description[$language['language_id']]) ? $faq_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-keyword<?php echo $language['language_id']; ?>"><?php echo $entry_meta_keyword; ?></label>
                    <div class="col-sm-10">
                      <textarea name="faq_description[<?php echo $language['language_id']; ?>][meta_keyword]" rows="5" placeholder="<?php echo $entry_meta_keyword; ?>" id="input-meta-keyword<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($faq_description[$language['language_id']]) ? $faq_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
                    </div>
                  </div> -->
*/?>
                </div>
...
<?/*
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sidebar"><span data-toggle="tooltip" title="Выводить в боковой панеле слева от статьи">Отображать в рубрикаторе</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($bottom) { ?>
                      <input type="checkbox" name="sidebar" value="1" checked="checked" id="input-sidebar" />
                      <?php } else { ?>
                      <input type="checkbox" name="sidebar" value="1" id="input-sidebar" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="category_id" id="input-categories" class="form-control">
                    ...
                    <option value="<?=$category['faq_category_id']?>" <? echo ($category['faq_category_id'] == $category_id) ? 'selected="selected"' : '' ?>><?=$category['name']?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
