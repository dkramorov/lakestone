            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-title<?php echo $language['language_id']; ?>"><?php echo $entry_image; ?></label>
                    <div class="col-sm-10">
                      <a id="thumb-image<?php echo $language['language_id']; ?>" href="" data-toggle="image" class="img-thumbnail"><img src="<?php echo isset($news_description[$language['language_id']]['image_url']) ? $news_description[$language['language_id']]['image_url'] : $placeholder; ?>" data-placeholder="<?php echo $placeholder; ?>" /></a>
                      <input type="hidden" name="news_description[<?php echo $language['language_id']; ?>][image]" value="<?php echo isset($news_description[$language['language_id']]['image']) ? $news_description[$language['language_id']]['image'] : ''; ?>" id="input-image<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea name="news_description[<?php echo $language['language_id']; ?>][announce]" placeholder="<?php echo $entry_announce; ?>" id="input-announce<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['announce'] : ''; ?></textarea>
