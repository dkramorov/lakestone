  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a target="product" href="<?=$button_view?>" data-toggle="tooltip" title="посмотреть на сайте" class="btn btn-default"><i class="fa fa-eye"></i></a>
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-add_links" data-toggle="tab">Добавочные линки</a></li>
            <li><a href="#tab-custom_icons" data-toggle="tab">Иконки для продукта</a></li>
          </ul>
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-yml_name<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_yml_name; ?>"><?php echo $entry_yml_name; ?></span></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][yml_name]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['yml_name'] : ''; ?>" placeholder="YML: name" id="input-yml_name<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-yml_model<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_yml_model; ?>"><?php echo $entry_yml_model; ?></span></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][yml_model]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['yml_model'] : ''; ?>" placeholder="YML: model" id="input-yml_model<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-short<?php echo $language['language_id']; ?>"><?php echo $entry_short; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][short]" placeholder="<?php echo $entry_short; ?>" id="input-short<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['short'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?=$entry_externalLink?></span></label>
                <div class="col-sm-10">
                  <div class="input-group">
                    <span class="input-group-addon"><?=$entry_externalId?></span>
                    <input type="text" name="externalLink[Id]" value="<?=$internalId?>" class="form-control" />
                  </div>
                  <div class="input-group">
                    <span class="input-group-addon"><?=$entry_externalCode?></span>
                    <input type="text" name="externalLink[Code]" value="<?=$externalCode?>" class="form-control" />
                  </div>
                  <div class="input-group">
                    <span class="input-group-addon"><?=$entry_externalCodeMod?></span>
                    <input type="text" name="externalLink[CodeMod]" value="<?=$externalCodeMod?>" class="form-control" /></form>
                  </div>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-links">
              <div class="form-group control-label">
                <label class="col-sm-2 control-label" for="input-need_spread">Требуется распространить на сабдомены</label>
                <div class="col-sm-10">
                  <input style="margin-top:20px" class="form-control" type="checkbox" name="need_spread" value="1" id="input-need_spread" <?=($need_spread ? 'checked' : '')?> />
                </div>
              </div>
              <div class="form-group">
                ...
                <table id="special" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left"><?php echo $entry_customer_group; ?></td>
                      <td class="text-right"><?php echo $entry_priority; ?></td>
                      <td class="text-right">Процент скидки</td>
                      <td class="text-right"><?php echo $entry_price; ?></td>
                      <td class="text-left"><?php echo $entry_date_start; ?></td>
                      <td class="text-left"><?php echo $entry_date_end; ?></td>
                      <td></td>
                  ...
                  <tbody>
                    ...
                    <tr id="special-row<?php echo $special_row; ?>">
                      ...
                      <td class="text-right"><input type="text" class="form-control calc_percent" data-price="<?=$price?>" placeholder="0" /></td>
                      <td class="text-right"><input type="text" name="product_special[<?php echo $special_row; ?>][price]" value="<?php echo $product_special['price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control calc_price" /></td>
                      <td class="text-left" style="width: 20%;"><div class="input-group date">
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      <td class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail" data-directory="<?=$product_image['directory']?>">
                        <? if ($product_image['video']) { ?>
                        <video controls width="250"><source src="<?=$product_image['thumb']?>" type="video/mp4"/></video>
                        <div class="text-center">Заменить ролик</div>
                        <? } else {?>
                      ...
                      <td class="text-right">
                      	<select name="product_image[<?php echo $image_row; ?>][position]">
			  <!--<input type="text" name="product_image[<?php echo $image_row; ?>][position]" value="<?php echo $product_image['position']; ?>" placeholder="<?php echo $entry_position; ?>" class="form-control" />-->
			  <option value="0" <?php echo ($product_image['position'] == 0 ? 'selected' : '')?>>Регулярная</option>
			  <option value="1" <?php echo ($product_image['position'] == 1 ? 'selected' : '')?>>В каталоге</option>
			  <option value="2" <?php echo ($product_image['position'] == 2 ? 'selected' : '')?>>Слайдер</option>
			  <option value="99" <?php echo ($product_image['position'] == 99 ? 'selected' : '')?>>Скрыта</option>
                      	</select>
                      </td>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="product_link_<?=$ProductLinkId?>">
                      <td><input name="product_link[<?=$ProductLinkId?>][name]" value="<?=$product_link['name']?>" class="form-control"></td>
                      <td><input name="product_link[<?=$ProductLinkId?>][href]" value="<?=$product_link['href']?>" class="form-control"></td>
                      <td><input name="product_link[<?=$ProductLinkId?>][sort_order]" value="<?=$product_link['sort_order']?>" class="form-control"></td>
                      <td><button type="button" onclick="$('#product_link_<?=$ProductLinkId++?>').remove();" data-toggle="tooltip" title="Удалить" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                    </tr>
                    <? } ?>
                  </tbody>
                    <tfoot>
                        <tr>
                            <td colspan="3"></td>
                            <td class="text-left"><button type="button" onclick="addProductLink();" data-toggle="tooltip" title="Добавить" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                        </tr>
                    </tfoot>
                </table>
              </div>
            ...
            <div class="tab-pane" id="tab-custom_icons">
              <div class="table-responsive">
                <table id="custom_icons" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left">Иконки для продукта</td>
                      <td class="text-right"><?php echo $entry_sort_order; ?></td>
                  ...
                  <tbody>
                    <?php $custom_icon_row = 0; ?>
                    <?php foreach ($product_custom_icons as $product_custom_icon) { ?>
                    <tr id="custom_icon-row<?php echo $custom_icon_row; ?>">
                      <td class="text-left"><a href="" id="thumb-custom_icon<?php echo $custom_icon_row; ?>" data-toggle="image" class="img-thumbnail" data-directory="<?=$product_custom_icon['directory']?>">
                        <img src="<?php echo $product_custom_icon['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                        <input type="hidden" name="product_custom_icon[<?php echo $custom_icon_row; ?>][image]" value="<?php echo $product_custom_icon['image']; ?>" id="input-custom_icon<?php echo $custom_icon_row; ?>" />
                      </td>
                      <td class="text-right"><input type="text" name="product_custom_icon[<?php echo $custom_icon_row; ?>][sort_order]" value="<?php echo $product_custom_icon['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
                      <td class="text-right"><input type="text" name="product_custom_icon[<?php echo $custom_icon_row; ?>][name]" value="<?php echo $product_custom_icon['name']; ?>" placeholder="<?php echo $entry_description; ?>" class="form-control" /></td>
                      <td class="text-left"><button type="button" onclick="$('#custom_icon-row<?php echo $custom_icon_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                    </tr>
                    <?php $custom_icon_row++; ?>
                    <?php } ?>
                  </tbody>
                  <tfoot>
                    <tr>
                      <td colspan="3"></td>
                      <td class="text-left"><button type="button" onclick="addCustomIcon();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
...
var ProductLinkId = <?=$ProductLinkId?>;
function addProductLink() {
	ProductLinkId += 1;
	var html = '<tr id="product_link_' + ProductLinkId + '">';
	html += '<td><input name="product_link['+ ProductLinkId +'][name]" class="form-control"></td>';
	html += '<td><input name="product_link['+ ProductLinkId +'][href]" class="form-control"></td>';
	html += '<td><input name="product_link['+ ProductLinkId +'][sort_order]" class="form-control"></td>';
	html += '<td><button type="button" onclick="$(\'#product_link_' + ProductLinkId + '\').remove();" data-toggle="tooltip" title="Удалить" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
	html += '</td>';
...
function addSpecial() {
	...
	html += '  <td class="text-right"><input type="text" placeholder="0" class="form-control calc_percent" data-price="<?=$price?>" /></td>';
	html += '  <td class="text-right"><input type="text" name="product_special[' + special_row + '][price]" value="" placeholder="<?php echo $entry_price; ?>" class="form-control calc_price" /></td>';
...
$('input.calc_percent').on('input change', function() {
	var $t = $(this),
			$p = $t.parents('tr'),
			price = $t.attr('data-price'),
			$pr = $p.find('input.calc_price');
	$pr.val(price - (price / 100 * $t.val()));
})
$('input.calc_price').on('input change', function() {
	var $t = $(this),
			$p = $t.parents('tr'),
			$per = $p.find('input.calc_percent'),
			price = $per.attr('data-price');
	$per.val(Math.round((100 - 100 * $t.val() / price) * 100) / 100);
})
//--></script>
  <script type="text/javascript"><!--
...
function addImage() {
  ...
  html += '<td class="text-right"><select name="product_image[<?php echo $image_row; ?>][position]"><option value="0">Регулярная</option><option value="1">В каталоге</option><option value="2">Слайдер</option><option value="99">Скрыта</option></select></td>';
...
//--></script>
  ...
  <script type="text/javascript"><!--
var custom_icon_row = <?php echo $custom_icon_row; ?>;

function addCustomIcon() {
	html  = '<tr id="custom_icon-row' + custom_icon_row + '">';
	html += '  <td class="text-left"><a href="" id="thumb-custom_icon' + custom_icon_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_custom_icon[' + custom_icon_row + '][image]" value="" id="input-custom_icon' + custom_icon_row + '" /></td>';
	html += '  <td class="text-right"><input type="text" name="product_custom_icon[' + custom_icon_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
    html += '  <td class="text-right"><input type="text" name="product_custom_icon[' + custom_icon_row + '][name]" value="" placeholder="<?php echo $entry_description; ?>" class="form-control" /></td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#custom_icon-row' + custom_icon_row  + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
	html += '</tr>';

	$('#custom_icons tbody').append(html);
