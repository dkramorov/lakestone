          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-review_type">Тип отзыва</label>
                <select name="filter_review_type" id="input-review_type" class="form-control" />
                	<option value="*"></option>
                	<option value="0"<?php if ($filter_review_type == '0') { echo ' selected="selected"'; } ?>>Отзывы на товар</option>
                	<option value="1"<?php if ($filter_review_type == '1') { echo ' selected="selected"'; } ?>>Вопросы к товару</option>
                	<option value="2"<?php if ($filter_review_type == '2') { echo ' selected="selected"'; } ?>>Отзывы на статьи в блоге</option>
                </select>
              </div>
						</div>
					</div>
...
$('#button-filter').on('click', function() {
	...
	var filter_review_type = $('select[name=\'filter_review_type\']').val();
	
	if (filter_review_type != '*') {
		url += '&filter_review_type=' + encodeURIComponent(filter_review_type);
	}
