                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    <td class="text-left"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][title]" value="<?php echo $banner_image['title']; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
                      ...
                      <?php } ?></td>
                    <td class="text-left"><textarea type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][text]" placeholder="<?php echo $entry_text; ?>" class="form-control"><?php echo $banner_image['text']; ?></textarea></td>
                    <td class="text-left"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][button]" value="<?php echo $banner_image['button']; ?>" placeholder="<?php echo $entry_button; ?>" class="form-control" /></td>
...
function addImage(language_id) {
  ...
  html += '  <td class="text-left"><textarea type="text" name="banner_image[' + language_id + '][' + image_row + '][text]" value="" placeholder="<?php echo $entry_text; ?>" class="form-control"></textarea></td>';	
  html += '  <td class="text-left"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][button]" value="" placeholder="<?php echo $entry_button; ?>" class="form-control" /></td>';
