            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="module_description[<?php echo $language['language_id']; ?>][template]" placeholder="<?php echo $entry_template; ?>" id="input-heading<?php echo $language['language_id']; ?>" value="<?php echo isset($module_description[$language['language_id']]['template']) ? $module_description[$language['language_id']]['template'] : ''; ?>" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
