      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-instagram" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status">Access token</label>
            <div class="col-sm-10">
              <input name="instagram_token" id="input-token" class="form-control" value="<?=$instagram_token?>">
            </div>
          </div>
