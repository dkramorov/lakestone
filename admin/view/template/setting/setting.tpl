...
<div id="content">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting"
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab-template" data-toggle="tab">Шаблоны оформления</a></li>
                        ...
                        <li><a href="#tab-links" data-toggle="tab">Линки для аксессуаров</a></li>
                    </ul>
                    <div class="tab-content">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="config_meta_title"
                                           ...
                                           placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title"
                                           class="form-control"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="config_meta_description" rows="5"
                                              ...
                                              class="form-control"><?php echo $config_meta_description; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-meta-keyword"><?php echo $entry_meta_keyword; ?></label>
                                <div class="col-sm-10">
                                    <textarea name="config_meta_keyword" rows="5"
                                              placeholder="<?php echo $entry_meta_keyword; ?>" id="input-meta-keyword"
                                              class="form-control"><?php echo $config_meta_keyword; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                        ...
                        <div class="tab-pane" id="tab-store">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="input-owner"><?php echo $entry_owner; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_owner" value="<?php echo $config_owner; ?>"
                                           placeholder="<?php echo $entry_owner; ?>" id="input-owner"
                                           class="form-control"/>
									<?php if ($error_owner) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="config_open" rows="5" placeholder="<?php echo $entry_open; ?>"
                                              id="input-open"
                                              class="form-control"><?php echo $config_open; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="config_comment" rows="5" placeholder="<?php echo $entry_comment; ?>"
                                              id="input-comment"
                                              class="form-control"><?php echo $config_comment; ?></textarea>
                                </div>
                            </div>
							<?php if ($locations) { ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab-template">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-product-title">Шаблон для meta-title
                                    товара</label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_product_title"
                                           value="<?php echo $config_product_title; ?>"
                                           placeholder="Шаблон для meta-title товара" id="input-product-title"
                                           class="form-control"/>
									<?php if ($error_product_title) { ?>
                                        <div class="text-danger"><?php echo $error_product_title; ?></div>
									<?php } ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-product-description">Шаблон для
                                    meta-description товара</label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_product_description"
                                           value="<?php echo $config_product_description; ?>"
                                           placeholder="Шаблон для meta-description товара"
                                           id="input-product-description" class="form-control"/>
									<?php if ($error_product_description) { ?>
                                        <div class="text-danger"><?php echo $error_product_description; ?></div>
									<?php } ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-category-title">Шаблон для meta-title
                                    категории</label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_category_title"
                                           value="<?php echo $config_category_title; ?>"
                                           placeholder="Шаблон для meta-title категории" id="input-category-title"
                                           class="form-control"/>
									<?php if ($error_category_title) { ?>
                                        <div class="text-danger"><?php echo $error_category_title; ?></div>
									<?php } ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-category-description">Шаблон для
                                    meta-description категории</label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_category_description"
                                           value="<?php echo $config_category_description; ?>"
                                           placeholder="Шаблон для meta-description категории"
                                           id="input-category-description" class="form-control"/>
									<?php if ($error_category_description) { ?>
                                        <div class="text-danger"><?php echo $error_category_description; ?></div>
									<?php } ?>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading">В шаблонах допустимы макросы</div>
                                <div class="panel-body">
                                    <p>Из настроек магазина:</p>
                                    <ul>
                                        <li>{phone} - телефон магазина</li>
                                    </ul>
                                    <p>Из карточки товара:</p>
                                    <ul>
                                        <li>{product_name} - название товара</li>
                                        <li>{product_price} - регулярная цена товара</li>
                                        <li>{product_special} - акционная цена товара</li>
                                        <li>{product_actual} - действующая цена товара</li>
                                    </ul>
                                    <p>Из категории:</p>
                                    <ul>
                                        <li>{category_name} - название категории</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="tab-mail">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="config_mail_alert_email" rows="5"
                        ...
                        <div class="tab-pane" id="tab-links">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    Ссылки с иконок для страниц товаров по умолчанию
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                        <tr>
                                            <td class="text-left">Иконка</td>
                                            <td class="text-left">Имя</td>
                                            <td class="text-left">Линк</td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <? foreach ($config_accessory_link as $id => $link) {?>
                                        <tr>
                                          <td>
                                            <a data-directory="catalog\icons" id="thumb-icon-<?=$id?>" data-toggle="image" class="img-thumbnail"><div class="image"><img data-placeholder="<?=$link['placeholder'] ?>" src="<?= $link['icon'] ?>"></div></a>
                                            <input type="hidden" id="config_accessory_link_<?=$id?>"
                                                name="config_accessory_link[<?=$id?>][icon]"
                                                value="<?= $config_accessory_link[$id]['icon'] ?>"
                                                class="form-control"
                                                placeholder="Иконка #<?=$id?>"></td>
                                          <td><input name="config_accessory_link[<?=$id?>][name]"
                                              value="<?= $config_accessory_link[$id]['name'] ?>"
                                              class="form-control"
                                              placeholder="Название #<?=$id?>"></td>
                                          <td><input name="config_accessory_link[<?=$id?>][href]"
                                              value="<?= $config_accessory_link[$id]['href'] ?>"
                                              class="form-control"
                                              placeholder="Ссылка #<?=$id?>"></td>
                                        </tr>
                                        <? } ?>
                                        </tbody>
                                    </table>
    ...
    $('[id^="thumb-icon-"] img[src=""]').each(function () {
