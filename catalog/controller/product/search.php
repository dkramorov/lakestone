...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		$this->document->addStyle('catalog/view/theme/lakestone/stylesheet/search.min.css');

		if (isset($this->request->get['search'])) {
			$this->document->search = $search = $this->request->get['search'];
		} else {
			$search = '';
		}
		...
		$data['products'] = array();
		$data['setting'] = array();
		$data['setting']['width'] = $this->config->get($this->config->get('config_theme') . '_image_related_width');
		$data['setting']['height'] = $this->config->get($this->config->get('config_theme') . '_image_related_height');
