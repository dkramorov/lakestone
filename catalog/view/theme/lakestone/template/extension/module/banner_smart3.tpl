...
.banner_smart3 .banner_smart_slider .owl-dots {
  position: absolute;
  opacity: 0;
...
.banner_smart3 .banner_smart_slider:hover .owl-dots {
  transition: opacity ease 0.5s;
  opacity: 1;
}
.banner_smart3 .banner_smart_slider .owl-dots .owl-dot {
  border: solid thin black;
  height: 4px;
  width: 15px;
  margin: 0 2px;
}
.banner_smart3 .banner_smart_slider .owl-dots .owl-dot.active {
  background-color: black;
}
.banner_smart3 .banner_smart_slider:hover .owl-nav > button {
  opacity: 0.5;
}
.banner_smart3 .banner_smart_slider .owl-nav > button:hover {
  opacity: 1;
}
.banner_smart3 .banner_smart_slider .owl-nav > button {
...
.banner_smart3 .banner_smart_slider .owl-nav .fa {
  font-size: 40px;
}
.banner_smart3 .banner_smart_slider .owl-nav .owl-prev {
  left: 1%;
}
.banner_smart3 .banner_smart_slider .owl-nav .owl-next {
  right: 1%;
}
.banner_smart3 .banner {
  position: relative;
}
.banner_smart3 .title, .banner_smart3 .text, .banner_smart3 .button {
  position: absolute;
}
.banner_smart3 .animated {
  opacity: 0;
}
.banner_smart3 .banner_smart_slider .animated {
  right: 10%;
}
.banner_smart3 .banner_smart_slider .title {
  top: 0;
  width: 40%;
}
.banner_smart3 .title,
.banner_smart3 .title1 {
...
.banner_smart3 .button {
  top: 60%;
  width: 40%;
}
.banner_smart3 .button-black {
  /* margin: auto; */
...
.banner_smart3 .banner_smart_right .button {
  top: 70%;
  z-index: 10;
}
.banner_smart3 .banner_smart_right .title {
  top: 5%;
}
.banner_smart3 .banner_smart_right .text {
  top: 30%;
}
.banner_smart3 div.to_right > div {
  right: 10%;
  float: right;
  text-align: right;
}
.banner_smart3 div.to_center {
  text-align: center;
}
.banner_smart3 div.to_center > div {
  margin: auto;
  right: 0;
  width: 100%;
  text-align: center;
}
.banner_smart3 div.black {
  background-color: black;
}
.banner_smart3 div.black img {
  opacity: 0;
}
.banner_smart3 div.black .button > div {
  border: solid thin white;
  border-bottom: none;
}
</style>
<div id="banner_smart<?php echo $module; ?>" class="banner_smart3">
  <div class="row">
    <div class="col-sm-4">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="banner black banner_smart_right to_center">
            <? if ($banner2['video']) { ?>
            <iframe class="video" width="<?=$banner2['width']?>" height="<?=$banner2['height']?>" src="https://www.youtube.com/embed/<?=$banner2['video']['vid']?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            <script>
